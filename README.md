...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/idds-client-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13449&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/idds-client-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `idds-client` can be installed with:

```
conda install idds-client
```

It is possible to list all of the versions of `idds-client` available on your platform with:
